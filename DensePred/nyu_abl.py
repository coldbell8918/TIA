...
checkpoint = torch.load('/workspace/UniversalRepresentations/DensePred/results/mtl-baselines_2/resnet152_deeplab_head_mtl_baselines_vanilla_uniform_model_best.pth.tar')
